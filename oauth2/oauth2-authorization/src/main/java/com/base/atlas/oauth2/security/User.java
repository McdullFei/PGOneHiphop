...
public class User implements UserDetails, CredentialsContainer {
  ...
  private final String atlasId;//定制属性
  ...
  public User(String username, String password,
              Collection<? extends GrantedAuthority> authorities, String htId) {
    this(username, password, true, true, true, true, authorities, htId);
  }
  ...
  public User(String username, String password, boolean enabled,
              ...
              boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities, String atlasId) {
  ...
  public String toString() {
    ...
    sb.append("AtlasId: ").append(this.atlasId).append("; ");
  ...
  public static class UserBuilder {
     ...
     * @return
     */
    public User.UserBuilder atlasId(String atlasId) {
      this.atlasId = atlasId;
      return this;
    }
    ...
    public UserDetails build() {
      return new User(username, password, !disabled, !accountExpired,
          !credentialsExpired, !accountLocked, authorities, atlasId);
    }
  }
}
